    ...
    return (
        <Box borderBottom='1px solid #80808033' w='full' background='transparent'>
            <HStack justify='space-between' px={6} py={4} mt='2rem' w='full' h='87px'>
                ...
                <Flex justify='space-between' w='361px' color='dark.900' fontSize='18px' fontWeight='medium'>
                ...
                <Button onClick={() => navigate('/contact')} bg='brand.900' className="text-white text-[18px] font-medium p-6 rounded-lg">
                    Contact Us
                </Button>
            </HStack>
        </Box>
