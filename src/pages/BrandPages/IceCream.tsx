                ...
                <Flex ref={aboutRef} justifyContent={"center"} w={"full"} color="dark.900" bgColor="white" className="relative py-16 px-3 md:px-16 ">
                    <Flex className="flex-col lg:flex-row" justifyContent={"center"} alignItems={"end"} w={"full"} >
                        <Span className="lg:mr-10" w={{ base: "full", lg: "fit" }}>
                            <Text fontSize={{ base: "1.5rem", lg: "2.1rem" }} w={{ base: "full", lg: "23rem" }} fontWeight={"bold"}>About Ice Cream</Text>
                        ...
                        <Span className="mt-4 lg:mt-0" fontSize={{ base: '16px', md: "1.1rem" }} w={{ base: "full", lg: "43rem" }} color={"gray.90"}>
                            <Text>
                                Welcome to our Ice Cream brand, where every scoop is a celebration! As one of the city’s favorite dessert destinations, we’re passionate about crafting unforgettable moments with our irresistible range of flavors and toppings. Whether you crave a classic vanilla cone or want to explore bold, new creations, we have something for everyone.</Text>
